...
'cookie_pre' => 'LonkW_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
'cookie_ttl' => 0, //Cookie 生命周期，0 表示随浏览器进程

'js_path' => 'http://192.168.1.49:5008/phpsso_server/statics/js/', //CDN JS
'css_path' => 'http://192.168.1.49:5008/phpsso_server/statics/css/', //CDN CSS
'img_path' => 'http://192.168.1.49:5008/phpsso_server/statics/images/', //CDN img
'upload_path' => PHPCMS_PATH.'uploadfile/', //上传文件路径
'app_path' => 'http://192.168.1.49:5008/phpsso_server/',//动态域名配置地址
...
'errorlog' => 0, //是否保存错误日志
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'Or1LCAtmua9MIhesXoV2', // //Cookie密钥
'lang' => 'zh-cn',  //网站语言包
